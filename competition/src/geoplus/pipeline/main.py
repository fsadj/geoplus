...
5. 结尾追加 `## 最稳妥回答模板`，用 3-4 句压缩成最终可复用回答。"""
    ...
    if profile.summary_mode == "rebuttal":
        ...
        user = f"""围绕预设问题，生成一份“误解反驳 + 正解总结”文档（{profile.summary_length_hint}）。
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="baseline",
        help="生成配置：baseline / skeleton / stance / dimensions / dimensions_rebuttal / evidence / rebuttal / rebuttal_compact / rebuttal_extended / rebuttal_ultra",
    )
